  ...
  <div class="max-w-7xl mx-auto px-6 lg:px-10">
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
      ...
      <div>
        ...
        <div class="space-y-3">
          <a href="#home" class="block text-white/70 text-sm hover:text-primary transition-colors duration-200">Home</a>
          <a href="#about" class="block text-white/70 text-sm hover:text-primary transition-colors duration-200">About</a>
          <a href="#programs" class="block text-white/70 text-sm hover:text-primary transition-colors duration-200">Programs</a>
          <a href="#services" class="block text-white/70 text-sm hover:text-primary transition-colors duration-200">Services</a>
          <a href="#impact" class="block text-white/70 text-sm hover:text-primary transition-colors duration-200">Impact</a>
          <a href="#blog" class="block text-white/70 text-sm hover:text-primary transition-colors duration-200">Blog</a>
          <a href="#contact" class="block text-white/70 text-sm hover:text-primary transition-colors duration-200">Contact</a>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="space-y-3">
          <?php foreach (["Scholarships", "STEM Coaching", "Mentorship", "Community Outreach", "Workshops", "Annual Reports"] as $p): ?>
            <a href="#programs" class="block text-white/70 text-sm hover:text-primary transition-colors duration-200"><?= $p ?></a>
          <?php endforeach; ?>
        </div>
      </div>
    </div>
